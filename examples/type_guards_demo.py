...
def demo_validation():
    ...
    print(f"  'archive' is valid recommendation: {is_valid_prune_recommendation('archive')}")
    ...
    print(f"  'destroy' is valid recommendation: {is_valid_prune_recommendation('destroy')}")
