...
async def individual_clients():
    ...
    async with create_sekha_client(
        ...
        result: QueryResponse = await sekha.controller.query(
            query="TypeScript patterns", limit=5
        )
...
async def type_safe_usage():
    ...
    from sekha.types import SearchResult, extract_text, is_multi_modal_content
...
async def error_handling():
    ...
    async with create_sekha_client(
        ...
        try:
            ...
            await sekha.controller.get_conversation("non-existent-id")
